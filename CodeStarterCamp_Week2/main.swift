...
checkLottoWinnerByRound(myNumberSet: myLottoNumbers)
...
checkLottoWinnerByRound(searchRound: 1, myNumberSet: myLottoNumbers)
checkLottoWinnerByRound(searchRound: 8, myNumberSet: myLottoNumbers) // 아직 추첨되지 않은 round 입력시 오류 메시지 출력
