...
let a: [Int] = []
let b: [Int]? = nil // 배열 자체가 nil 일 수 있다. 다만, 배열이 존재한다면, 내부 요소는 Int 여야 한다.
let c: [Int?] = [1, 2, nil, 3, 4] // 배열 자체는 꼭 존재해야한다. 다만 배열 내부의 값이 nil 일 수 있다
let d: [Int?]? = nil // 배열 자체가 nil 일 수도 있고, 배열 내부의 값이 nil 일 수도 있다.
